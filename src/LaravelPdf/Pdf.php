<?php namespace aktiWeb\LaravelPdf;
...
class Pdf {
    ...
    /**
     * @see https://mpdf.github.io/what-else-can-i-do/pdf-a3-xmp-rdf.html
     * @param array $config
     ...
     * @return static
     */
    public function associateFile(array $config) {
        return $this->mpdf->SetAssociatedFiles([$config]);
    }
     ...
     * @return static
     */
    public function setXmpRdf($rdf) {
        return $this->mpdf->SetAdditionalXmpRdf($rdf);
    }
